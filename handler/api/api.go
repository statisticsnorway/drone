...
import (
	...
	"github.com/statisticsnorway/drone/handler/api/acl"
	"github.com/statisticsnorway/drone/handler/api/auth"
	"github.com/statisticsnorway/drone/handler/api/badge"
	globalbuilds "github.com/statisticsnorway/drone/handler/api/builds"
	"github.com/statisticsnorway/drone/handler/api/ccmenu"
	"github.com/statisticsnorway/drone/handler/api/events"
	"github.com/statisticsnorway/drone/handler/api/queue"
	"github.com/statisticsnorway/drone/handler/api/repos"
	"github.com/statisticsnorway/drone/handler/api/repos/builds"
	"github.com/statisticsnorway/drone/handler/api/repos/builds/logs"
	"github.com/statisticsnorway/drone/handler/api/repos/builds/stages"
	"github.com/statisticsnorway/drone/handler/api/repos/collabs"
	"github.com/statisticsnorway/drone/handler/api/repos/crons"
	"github.com/statisticsnorway/drone/handler/api/repos/encrypt"
	"github.com/statisticsnorway/drone/handler/api/repos/secrets"
	"github.com/statisticsnorway/drone/handler/api/repos/sign"
	globalsecrets "github.com/statisticsnorway/drone/handler/api/secrets"
	"github.com/statisticsnorway/drone/handler/api/system"
	"github.com/statisticsnorway/drone/handler/api/user"
	"github.com/statisticsnorway/drone/handler/api/users"
